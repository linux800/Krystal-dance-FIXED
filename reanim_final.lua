...
-- [MRXN FIX] safe wrapper supaya replicatesignal tidak crash kalau executor tidak support
local _replicatesignal_real = (typeof(replicatesignal) == "function") and replicatesignal or nil
replicatesignal = function(sig, ...)
	if _replicatesignal_real then
